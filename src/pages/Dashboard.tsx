    ...
    <div className="flex min-h-screen bg-background pt-16">
      <div className="w-64 border-r bg-card hidden md:block p-4 space-y-6">
        ...
        <nav className="space-y-1">
          ...
          <button 
            className={`w-full flex items-center space-x-2 px-3 py-2 rounded-md text-sm ${activeModule === "overview" ? "bg-primary text-primary-foreground" : "text-muted-foreground hover:bg-muted"}`}
          ...
          {!isProductionPartner && (
            <>
              <button 
                className={`w-full flex items-center space-x-2 px-3 py-2 rounded-md text-sm ${activeModule === "customers" ? "bg-primary text-primary-foreground" : "text-muted-foreground hover:bg-muted"}`}
              ...
              <button 
                className={`w-full flex items-center space-x-2 px-3 py-2 rounded-md text-sm ${activeModule === "partners" ? "bg-primary text-primary-foreground" : "text-muted-foreground hover:bg-muted"}`}
              ...
              <button 
                className={`w-full flex items-center space-x-2 px-3 py-2 rounded-md text-sm ${activeModule === "products" ? "bg-primary text-primary-foreground" : "text-muted-foreground hover:bg-muted"}`}
              ...
              <button 
                className={`w-full flex items-center space-x-2 px-3 py-2 rounded-md text-sm ${activeModule === "quotes" ? "bg-primary text-primary-foreground" : "text-muted-foreground hover:bg-muted"}`}
          ...
          <button 
            className={`w-full flex items-center space-x-2 px-3 py-2 rounded-md text-sm ${activeModule === "orders" ? "bg-primary text-primary-foreground" : "text-muted-foreground hover:bg-muted"}`}
          ...
          <button 
            className={`w-full flex items-center space-x-2 px-3 py-2 rounded-md text-sm ${activeModule === "calendar" ? "bg-primary text-primary-foreground" : "text-muted-foreground hover:bg-muted"}`}
          ...
          {!isProductionPartner && (
            <>
              ...
              <button 
                className={`w-full flex items-center space-x-2 px-3 py-2 rounded-md text-sm ${activeModule === "notifications" ? "bg-primary text-primary-foreground" : "text-muted-foreground hover:bg-muted"}`}
              ...
              <button 
                className={`w-full flex items-center space-x-2 px-3 py-2 rounded-md text-sm ${activeModule === "settings" ? "bg-primary text-primary-foreground" : "text-muted-foreground hover:bg-muted"}`}
